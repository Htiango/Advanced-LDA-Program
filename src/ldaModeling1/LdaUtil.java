...
public class LdaUtil
{
     ...
     * @param result
     */
    public static void explain(Map<String, Double>[] result, Map<Integer, Map<String,Double>> outputs)
    {
//      outputs = new ArrayList<String> ();
        ...
        for (Map<String, Double> topicMap : result)
        {
        	...
        	Integer topicIndex = new Integer(i);        	
            ...
            outputs.put(topicIndex, topicMap);
